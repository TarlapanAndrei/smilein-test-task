...
exports.protect = catchAsync_1.catchAsync(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decoded, decodedString, decodedObject, freshUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!token) {
                    return [2 /*return*/, next(new api_error_1.default(404, 'you are not loged in, please login or sign up'))];
                }
                decoded = jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET);
                decodedString = JSON.stringify(decoded);
                decodedObject = JSON.parse(decodedString);
                return [4 /*yield*/, typeorm_1.getRepository(User_1.User).findOneOrFail(decodedObject.id)];
            case 1:
                freshUser = _a.sent();
                if (!freshUser) {
                    return [2 /*return*/, next(new api_error_1.default(401, 'you are not authorized, please login'))];
                }
                if (changedPasswordAfter(decodedObject.iat, freshUser)) {
                    return [2 /*return*/, next(new api_error_1.default(403, 'user recently changed password! Please login again'))];
                }
...
var changedPasswordAfter = function (JWTTimestamp, user) {
    if (user.passwordChangeAt) {
        var changedTimeStamp = user.passwordChangeAt.getTime() / 1000;
